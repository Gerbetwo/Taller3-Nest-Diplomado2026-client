...
import { useCreateDepartments, useDepartments, useDeleteDepartments } from "../api/departments.queries";
            ...
            <main className="mx-auto max-w-5xl px-4 py-8 space-y-8">
                ...
                <form onSubmit={onCreate} className="rounded-xl border border-slate-800 bg-slate-900 p-6 shadow-xl space-y-4">
                    ...
                    <div className="flex items-center justify-between pt-2">
                        ...
                        >
                            {createMut.isPending ? "Procesando..." : "Crear Department"}
                        </button>
                        {createMut.isError && (
                                    ...
                                    <tr key={c.id} className="group hover:bg-slate-800/40 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            <button
                                                ...
                                                onClick={() => {
                                                    if (!confirm("¿Seguro que deseas borrar este Deparments?")) return;
